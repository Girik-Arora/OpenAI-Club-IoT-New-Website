...
import { InteractiveExecutiveTeam } from './InteractiveExecutiveTeam';
...
export const Hero: React.FC = () => {
  return (
    <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-16 sm:pb-24 flex flex-col items-center text-center relative z-20 font-sans">
      ...
      <div className="w-full flex flex-col items-center bg-black/60 backdrop-blur-xl border border-white/15 rounded-3xl p-8 sm:p-12 shadow-2xl shadow-black/80 overflow-visible">
        ...
        {/* INTERACTIVE EXECUTIVE TEAM HERO PHOTO SHOWCASE */}
        <InteractiveExecutiveTeam />
